...
namespace App\Models {
     ...
     * @property int $id
     * @property-read \App\Models\ParkingLot $parkingLot
     * @property-read \App\Models\User $user
     * @method static \Illuminate\Database\Eloquent\Builder<Booking>|Booking whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Booking>|Booking whereParkingLotId($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Booking>|Booking whereVehiclePlate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Booking>|Booking whereSource($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Booking>|Booking whereTotalFee($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Booking>|Booking wherePaymentMethod($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Booking>|Booking wherePaymentProof($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Booking>|Booking wherePaidAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Booking>|Booking wherePricingSnapshot($value)
     ...
     * @property int $id
     * @property-read \App\Models\ParkingLot $parkingLot
     * @method static \Illuminate\Database\Eloquent\Builder<CarRegistry>|CarRegistry whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CarRegistry>|CarRegistry whereParkingLotId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CarRegistry>|CarRegistry wherePlateNumber($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CarRegistry>|CarRegistry whereEntryTime($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CarRegistry>|CarRegistry whereExitTime($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CarRegistry>|CarRegistry whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CarRegistry>|CarRegistry whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CarRegistry>|CarRegistry newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CarRegistry>|CarRegistry newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CarRegistry>|CarRegistry query()
     * @method static \Illuminate\Database\Eloquent\Builder<CarRegistry>|CarRegistry active() {@see App\Models\CarRegistry::scopeActive()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<CarRegistry>|CarRegistry timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class CarRegistry extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property int $id
     * @property-read mixed $available_spaces
     * @property-read mixed $occupied_spaces
     * @property-read mixed $usage_percentage
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Booking> $bookings
     * @property-read int|null $bookings_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\CarRegistry> $carRegistries
     * @property-read int|null $car_registries_count
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot whereAddress($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot whereTotalCapacity($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot wherePricePerHour($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot whereLatitude($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot whereLongitude($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot whereWorkingHours($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot whereIsActive($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot wherePricingRules($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot whereImage($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot query()
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot active() {@see App\Models\ParkingLot::scopeActive()}
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot withStatus() {@see App\Models\ParkingLot::scopeWithStatus()}
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot search(mixed $search) {@see App\Models\ParkingLot::scopeSearch()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<ParkingLot>|ParkingLot timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class ParkingLot extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * App\Models\User
     *
     * @property int|null $parking_lot_id
     * @property string|null $phone
     ...
     * @property string $name
     * @property int $id
     * @property-read \App\Models\ParkingLot $assignedLot
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereParkingLotId($value)
